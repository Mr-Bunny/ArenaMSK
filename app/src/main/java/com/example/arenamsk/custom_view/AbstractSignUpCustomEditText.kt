...
abstract class AbstractSignUpCustomEditText: LinearLayout {
    ...
    private fun updateView() {
        when(currentState) {
            State.EMPTY -> {
                custom_edit_text.background = resources.getDrawable(R.drawable.edit_text_sign_up_background)
                custom_text_layout.hint = hint
                custom_text_layout.defaultHintTextColor = ColorStateList.valueOf(resources.getColor(R.color.edit_text_highlight_hint_color))
